package com.solution.shared.infrastructure.bus.command;
...
import com.solution.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections                          reflections = new Reflections("com.solution");
