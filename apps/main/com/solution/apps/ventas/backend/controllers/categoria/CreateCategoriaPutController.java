...
import com.solution.ventas.categoria.application.create.CreateCategoriaCommand;
...
@RestController
public final class CreateCategoriaPutController extends ApiController {
    public CreateCategoriaPutController(QueryBus queryBus, CommandBus commandBus) {
    ...
    public ResponseEntity<String> index(@PathVariable String id, @RequestBody Request request){
        ...
        dispatch(new CreateCategoriaCommand(id, request.nombre(), request.descripcion()));
