package com.solution.sales.shared.infrastructure;
...
public class SalesHibernateConfiguration {
    private final HibernateConfigurationFactory factory;
    private final Parameter config;
    private final String                        CONTEXT_NAME = "sales";

    public SalesHibernateConfiguration(HibernateConfigurationFactory factory, Parameter config) {
